...
const Familia = () => {
    ...
    const actualizarFamilia = (id, data) => {
        bdAdmin
    ...
    const submit = (data) => {
        if (actualizacion) {
            actualizarFamilia(data.id, data);
        } else {
            crearFamilia(data);
        }
    };
    return (
        <>
            ...
            <TablaFamilia
                ...
                filter={filter}
                search={search}
                actualizarFamiliaId={actualizarFamiliaId}
                eliminarFamilia={eliminarFamilia}
            />
            <FormFamilia
                toggle={toggle}
                modal={modal}
